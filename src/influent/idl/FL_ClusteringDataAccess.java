...
public interface FL_ClusteringDataAccess {
  ...
  /** Returns a set of entities by uid.
	 ...
	 @param contextId	the context to retrieve the clusters fr	om
	 @return 			entities */
  java.util.List<influent.idl.FL_Entity> getEntities(java.util.List<java.lang.String> entities, java.lang.String contextId) throws org.apache.avro.AvroRemoteException;
  ...
  java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Entity>> getAccounts(java.util.List<java.lang.String> entities, java.lang.String contextId) throws org.apache.avro.AvroRemoteException;
  ...
  java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Link>> getFlowAggregation(java.util.List<java.lang.String> entities, java.util.List<java.lang.String> focusEntities, influent.idl.FL_DirectionFilter direction, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date, java.lang.String srcContextId, java.lang.String dstContextId) throws org.apache.avro.AvroRemoteException;
  /** Returns links to other entities related to specify entities.  Each Link returned should
	 represent multiple records, used for displaying time series.
	 ...
	 @param contextId		the context to retrieve the clusters from
	 @return 				map of input entity IDs to an array of the links for that entity */
  java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Link>> getTimeSeriesAggregation(java.util.List<java.lang.String> entities, java.util.List<java.lang.String> focusEntities, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date, java.lang.String contextId) throws org.apache.avro.AvroRemoteException;
  /** Returns links to other entities related to specify entities. Each link returned should
	 represent one raw transaction.  For financial data, these transactions will form a ledger.
	 For communications or social data, these are un-aggregated links for drill down by the user.
  ...
  public interface Callback extends FL_ClusteringDataAccess {
    ...
    /** Returns a set of entities by uid.
	 ...
	 @param contextId	the context to retrieve the clusters fr	om
	 @return 			entities */
    void getEntities(java.util.List<java.lang.String> entities, java.lang.String contextId, org.apache.avro.ipc.Callback<java.util.List<influent.idl.FL_Entity>> callback) throws java.io.IOException;
    /** Returns a set of accounts for each given entity.
	 ...
	 @param contextId		the context to retrieve the clusters from
	 @return 				map of input entity IDs to an array of the accounts for that entity */
    void getAccounts(java.util.List<java.lang.String> entities, java.lang.String contextId, org.apache.avro.ipc.Callback<java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Entity>>> callback) throws java.io.IOException;
    /** Returns links to other entities related to specify entities. Each Link returned should
	 represent multiple records, used for displaying flow.
	 ...
	 @param dstContextId	the context to compute flow between clusters from (if null a new context is created for dst)
	 @return 				map of input entity IDs to an array of the links for that entity */
    void getFlowAggregation(java.util.List<java.lang.String> entities, java.util.List<java.lang.String> focusEntities, influent.idl.FL_DirectionFilter direction, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date, java.lang.String srcContextId, java.lang.String dstContextId, org.apache.avro.ipc.Callback<java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Link>>> callback) throws java.io.IOException;
    /** Returns links to other entities related to specify entities.  Each Link returned should
	 represent multiple records, used for displaying time series.
	 ...
	 @param contextId		the context to retrieve the clusters from
	 @return 				map of input entity IDs to an array of the links for that entity */
    void getTimeSeriesAggregation(java.util.List<java.lang.String> entities, java.util.List<java.lang.String> focusEntities, influent.idl.FL_LinkTag tag, influent.idl.FL_DateRange date, java.lang.String contextId, org.apache.avro.ipc.Callback<java.util.Map<java.lang.String,java.util.List<influent.idl.FL_Link>>> callback) throws java.io.IOException;
    /** Returns links to other entities related to specify entities. Each link returned should
	 represent one raw transaction.  For financial data, these transactions will form a ledger.
	 For communications or social data, these are un-aggregated links for drill down by the user.
