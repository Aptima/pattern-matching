...
FROM (
	...
	USING 'java -cp PM-0.0.1-SNAPSHOT.jar:hive_contrib.jar com.aptima.netstorm.algorithms.aptima.bp.hive.HiveMapScript com.aptima.netstorm.algorithms.aptima.bp.hive.HiveMapScript testQuery.txt'
...
INSERT OVERWRITE TABLE aptima_pm_result
	...
	USING 'java -cp PM-0.0.1-SNAPSHOT.jar:hive_contrib.jar com.aptima.netstorm.algorithms.aptima.bp.hive.HiveReduceScript com.aptima.netstorm.algorithms.aptima.bp.hive.HiveReduceScript'
